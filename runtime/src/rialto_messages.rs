...
//! Everything required to serve Evochain <-> Rialto messages.
...
/// Call-dispatch based message dispatch for Rialto -> Evochain messages.
...
mod tests {
	...
	fn ensure_millau_message_lane_weights_are_correct() {
		check_message_lane_weights::<bp_evochain::Evochain, Runtime, WithRialtoMessagesInstance>(
			bp_rialto::EXTRA_STORAGE_PROOF_SIZE,
